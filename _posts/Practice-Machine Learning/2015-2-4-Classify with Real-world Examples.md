...
这一章主要是简单的构建了一个分类器。首先是针对iris数据集，构建了一个只用阈值来分类的情况。之后简介了下交叉验证。然后考虑了更实际的数据集，使用了UCI的数据集，并考虑特征处理，使用最近邻分类器。最后，简单的说了一下多类别分类的情况。
...
<img src="http://chrispher.github.com/images/practicalML/bmls_ch2/output_8_1.png" height="100%" width="100%">
