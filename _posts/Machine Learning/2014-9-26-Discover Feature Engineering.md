...
- [2. Problem that Feature Engineering Solves](#Problem that Feature Engineering Solves)
- [3. Importance of Feature Engineering](#Importance of Feature Engineering)
- [4. What is Feature Engineering?](#What is Feature Engineering?)
- [5. Sub-Problems of Feature Engineering](#Sub-Problems of Feature Engineering)
    - [5.1 Feature](#Feature)
    - [5.2 Feature Importance](#Feature Importance)
    - [5.3 Feature Extraction](#Feature Extraction)
    - [5.4 Feature Selection](#Feature Selection)
    - [5.5 Feature Construction](#Feature Construction)
    - [5.6 Feature Learning](#Feature Learning)
- [6. Process of Feature Engineering](#Process of Feature Engineering)
    - [6.1 Process of Machine Learning](#Process of Machine Learning)
    - [6.2 Iterative Process of Feature Engineering](#Iterative Process of Feature Engineering)
- [7. General Examples of Feature Engineering](#General Examples of Feature Engineering)
    - [7.1 Decompose Categorical Attributes](#Decompose Categorical Attributes)
    - [7.2 Decompose a Date-Time](#Decompose a Date-Time)
    - [7.3 Reframe Numerical Quantities](#Reframe Numerical Quantities)
    - [7.4 Concrete Examples of Feature Engineering](#Concrete Examples of Feature Engineering)
- [8. More Resources on Feature Engineering](#More Resources on Feature Engineering)
    - [8.1 Books](#Books)
    - [8.1 Papers and Slides](#Papers and Slides)
    - [8.2 Links](#Links)
    - [8.3 Videos](#Videos)
